...
/* harmony import */ var _loginScript__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);

document.getElementById('login').addEventListener('click', event => {
  event.preventDefault();
  Object(_loginScript__WEBPACK_IMPORTED_MODULE_0__["login"])();
});
...
function login() {
  ...
  formData.append('password', password); // if (login === 'pogudina.l@mail.ru' && password === 'test123')
  // {
  ...
  fetch('./../dev/scripts/php/login.php', {
    method: "POST",
    body: formData
  }).then(res => res.json()).then(jsoned => console.log(jsoned)).then(() => {
