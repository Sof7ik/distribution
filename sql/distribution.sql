...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Сен 30 2020 г., 14:13
...
(122, 1, 'Проектирование интерфейсов пользователей', '', 214),
(123, 1, 'Графический дизайн и мультимедиа', '', 180),
(124, 1, 'Проектирование и разработка интерфейсов пользователя', '', 214),
(125, 1, 'Проектирование и разработка веб-приложений', '', 140),
(126, 7, 'ИЯ в ПД ', 'Иностранный язык в профессиональной деятельности', 46),
(127, 9, 'Физическая культура', '', 46),
(128, 4, 'Численные методы', '', 72),
(129, 19, 'Менеджмент в ПД', 'Менеджмент в профессиональной деятельности', 36),
(130, 13, 'ДОУ', 'Документационное обеспечение управления', 36),
(131, 2, 'Адаптивные информационные и коммуникационные технологии', '', 36),
(132, 1, 'Проектирование и разработка веб-приложений', '', 209),
(133, 1, 'Оптимизация веб-приложений', '', 260),
(134, 1, 'Обеспечение безопасности веб-приложений', '', 123);
...
--
ALTER TABLE `subjects`
  MODIFY `id_subject` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=135;
--
